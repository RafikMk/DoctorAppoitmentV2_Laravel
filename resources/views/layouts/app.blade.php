...
<head>
    ...
    <title>  Doctors Appointment                       <!-- Left Side Of Navbar 
  {{ config('app.name', 'Doctors Appointment') }}--></title>
    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                Doctors Appointment                       <!-- Left Side Of Navbar 
  {{ config('app.name', 'Doctors Appointment') }}-->
                </a>
