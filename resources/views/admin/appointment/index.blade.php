...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <br> 
            @if (isset($date))
                Your appointment schedule for: {{ $date }}
            @endif
        </div>
        <div class="card-body">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <tbody>
                    ...
                    <td><input type="checkbox" name="time[]"  value="12.20pm" @if(isset($times)){{ $times->contains('time', '12.2pam') ? 'checked' : '' }}@endif>12.20pm</td>
    ...
    @else
        <h3>Your Appointments List <span class="badge badge-info">{{ $appointments->count() }}</span></h3>
        <table class="table table-striped">
            <thead>
                <tr>
                    <th>#</th>
