            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="widget">
                    ...
                    <div class="progress progress-sm">
                        ...
                        style="width: 40%;background-color: #673ab7 !important;"  role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 20%;"></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12">
